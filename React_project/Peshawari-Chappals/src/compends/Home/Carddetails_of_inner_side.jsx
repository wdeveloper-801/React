    ...
    return (
        <>
            ...
            <div>
                ...
                {/* order div */}
                <div className="flex flex-col items-center lg:flex-row w-full h-auto lg:min-h-20 lg:items-start">

                    <div className="w-full h-full mt-8 sm:w-11/12 lg:w-2/3 flex justify-center items-center lg:mt-15">
                        <img className="w-full h-auto object-cover" src={state.url} alt="" />
                    </div>

                    <div className=' w-11/12  pb-10 overflow-y-auto flex items-center  flex-col lg:w-1/3 lg:mt-15'>
                        <div className='w-11/12  h-full flex flex-col mt-10'>
                            ...
                            <select id="shoes" name="shoes_size" class=" w-full lg-w-1/2 h-10  border border-gray-300 rounded-3xl text-center mt-5 bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                ...
                <div className='w-full mt-5 min-h-screen  flex flex-col items-center '>
                    ...
                    <div className='mt-5 h-full w-11/12 pb-3  flex items-center  flex-col'>
                        ...
                        {data.map((a, i) => (
                            ...
                            <div className="w-full max-w-2xl mx-auto overflow-hidden min-h-32 mt-5 border-2 border-gray-200 rounded-2xl">
